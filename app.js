...
function pagarClicked() {
  ...
  for (var i = 0; i < carritoItems.length; i++) {
    ...
    var subtotalItem = precioNumerico * parseInt(cantidad);
  ...
  var urlChatWhatsApp = 'https://wa.me/' + numeroTelefono + '?text=' + encodeURIComponent(mensajeAgradecimiento);

  // Abrir WhatsApp en una nueva ventana
  window.open(urlChatWhatsApp);

  // Mostrar mensaje de agradecimiento al cliente
  alert('¡Gracias por tu compra!');

  // Eliminar elementos del carrito y ocultarlo
